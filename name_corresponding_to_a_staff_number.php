...
<html lang="en">
	...
	<body>
		<nav>
			...
			<p>
			The DreamHome Site - Staff Operations - Find the name corresponding to a staff number
			</p>
		</nav>
    	<main>
<section>
...
echo "<p><b>Please select a staff number you would like to find a name for.<b><p>";
	...
	$result_id = mysql_query ($query)  # issue query
		...
		if (mysql_num_rows($result_id) == 0){   # checks to see if there are rows
			echo "<p><b>Sorry, There is no name listed for this staff number.<b><p>";  # message if not
		}else{
			echo ("<p><b>Here is the name listed for this Staff Number: <i>$staffnum</i>: <b><p>");
...
<br>
<p>
<input type="submit" name="Submit" value="Show The Staff's Name for this Staff Number">
</p>
</form>
</section>
		</main>
